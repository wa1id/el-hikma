...
const RamadanMarketLandingPage = () => {
  return (
    <div className="relative flex min-h-screen flex-col bg-beige pb-12">
      <div className="pointer-events-none absolute inset-0 flex justify-between px-4 sm:px-8">
      ...
      <div className="relative flex flex-col space-y-8 px-4 pt-16 sm:px-8 sm:pt-24">
        <div className="container mx-auto flex flex-col items-center justify-between gap-12 px-6 lg:flex-row lg:px-24">
          <div className="w-full space-y-6 text-center lg:w-3/5 lg:text-left">
            <div className="flex flex-col items-center gap-4 lg:flex-row lg:items-start lg:gap-16">
              <h1 className="font-berkshire-swash text-4xl font-bold text-secondary sm:text-5xl lg:text-7xl">
                Ramadan <br className="hidden lg:block" /> Markt
              </h1>
              <Star>€12,50 per ticket</Star>
            </div>
            <p className="mx-auto max-w-[580px] text-lg font-semibold text-secondary sm:text-xl lg:mx-0">
          ...
          <div className="flex w-full justify-center lg:w-2/5">
            <img
              className="h-auto w-[90%] max-w-[700px] sm:w-[85%] lg:w-[700px]"
              src="./Group.png"
              alt="Ramadan Market"
            />
          </div>
...
const EventInfoCards = () => {
  return (
    <div className="flex flex-col items-center gap-4 sm:flex-row">
      <InfoCard icon={<MapPinIcon className="size-8 sm:size-10" />}>
        Pesthofstraat 35, 2060 Antwerpen
        <br />
        (Stuivenbergsite)
      </InfoCard>

      <InfoCard icon={<CalendarDaysIcon className="size-8 sm:size-10" />}>
        21/03 - 30/03
        <br />
        16:00 - 22:00
      </InfoCard>
...
const RamadanMarketMarquee = () => {
  return (
    <Marquee speed={25} className="bg-primary py-2 sm:py-3">
